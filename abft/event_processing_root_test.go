...
func TestPushClassicRoots(t *testing.T) {
...
func TestPushRandomRoots(t *testing.T) {
	// generated by codegen4PushRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakePush(nodes, nil)
...
/*
// codegen4PushRandomRoot is for test data generation.
func codegen4PushRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakePush(nodes)
	// process events
	config := inter.Events{}
